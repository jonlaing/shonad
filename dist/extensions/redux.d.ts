...
export declare type CaseReducer<S = any, A extends PayloadAction<any, any> = PayloadAction> = (state: Draft<S>, action: A) => S | void | Draft<S>;
...
declare function _always<S extends State, V extends S[keyof S], A extends PayloadAction<any> = PayloadAction<any>>(lens: L.Lens<S, Maybe.Maybe<V>>): (val: V, state: S, action: A) => S;
declare function _always<S extends State, V extends S[keyof S], A extends PayloadAction<any> = PayloadAction<any>>(lens: L.Lens<S, Maybe.Maybe<V>>, val: V): CaseReducer<S, A>;
declare function _always<S extends State, V extends S[keyof S], A extends PayloadAction<any> = PayloadAction<any>>(lens: L.Lens<S, Maybe.Maybe<V>>, val: V, state: S): (action: A) => S;
declare function _always<S extends State, V extends S[keyof S], A extends PayloadAction<any> = PayloadAction<any>>(lens: L.Lens<S, Maybe.Maybe<V>>, val: V, state: S, action: A): S;
